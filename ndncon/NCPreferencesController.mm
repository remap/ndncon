...
NSString* const kIdentityKey = @"Default identity";
...
{
    [self saveParam:identity atPathByComponents:kGeneralSectionKey, kIdentityKey, nil];
}

-(NSString *)identity
{
    return [self getParamAtPathByComponents:kGeneralSectionKey, kIdentityKey, nil];
}
